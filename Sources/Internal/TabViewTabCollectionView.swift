...
class TabViewTabCollectionView: UICollectionView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private func applyTheme(_ theme: TabViewTheme) {
        for cell in visibleCells.flatMap({ $0 as? TabViewTab}) {
            cell.theme = theme
        }
    }
